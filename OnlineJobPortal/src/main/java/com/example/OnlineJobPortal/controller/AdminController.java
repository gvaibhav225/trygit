...
public class AdminController {
	...
	public ResponseEntity<String> save(@Valid @RequestBody AdminDto adminDto, BindingResult bindingResult) throws InvalidAdminException {
		if(bindingResult.hasErrors()) {
			return new ResponseEntity<String>("your credentials are invalid",HttpStatus.BAD_REQUEST);
		}
		
		Admin saveAdmin = adminServ.save(adminDto);
		return new ResponseEntity<String>("The user is saved",HttpStatus.CREATED);
	}
